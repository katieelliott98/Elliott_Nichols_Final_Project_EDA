...
ggplot()+geom_sf(data=states, fill="white")+geom_sf(data=locations.sf, size=locations.sf$MW)+labs(title = "Figure 3: Hydroelectric Plants Shown by Generation Capacity")
