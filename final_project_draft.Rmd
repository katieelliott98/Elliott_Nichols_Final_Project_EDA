...
ggplot(high_shoals_power_water, aes(x=average_monthly_discharge, y=Power))+geom_point()
...
ggplot(william_f_matson_power_water, aes(x=average_monthly_discharge, y=Power))+geom_point()



otis_power_water<-left_join(Otis_Generation_Complete, gage_01054500)

ggplot(otis_power_water, aes(x=average_monthly_discharge, y=Power))+geom_point()



ware_power_water<-left_join(Ware_Shoals_Generation_Complete, gage_02163001)

ggplot(ware_power_water, aes(x=average_monthly_discharge, y=Power))+geom_point()



garland_power_water<-left_join(Garland_Generation_Complete, gage_06279940)

ggplot(garland_power_water, aes(x=average_monthly_discharge, y=Power, color=Year))+geom_point()



chester_power_water<-left_join(Chester_Generation_Complete, gage_13046000)

ggplot(chester_power_water, aes(x=average_monthly_discharge, y=Power))+geom_point()



tri_county_power_water<-left_join(Tri_County_Generation_Complete, gage_09146200)

ggplot(tri_county_power_water, aes(x=average_monthly_discharge, y=Power, color=Year))+geom_point()
...
ggplot(quail_power_water, aes(x=average_monthly_discharge, y=Power, color=Year))+geom_point()
...
plot_hs<-ggplot(High_Shoals_Generation, aes(x=Date, y=Power))+geom_line(color="blue")+labs(x="", y="", title = "High Shoals")

plot_school<-ggplot(Schoolfield_Generation, aes(x=Date, y=Power))+geom_line(color="blue")+labs(x="", y="", title = "Schoolfield")

plot_matson<-ggplot(Matson_Generation, aes(x=Date, y=Power))+geom_line(color="blue")+labs(x="", y="", title = "Matson")

plot_otis<-ggplot(Otis_Generation, aes(x=Date, y=Power))+geom_line(color="blue")+labs(x="", y="", title = "Otis")

plot_ws<-ggplot(Ware_Shoals_Generation, aes(x=Date, y=Power))+geom_line(color="blue")+labs(x="", y="", title = "Ware Shoals")

plot_gar<-ggplot(Garland_Generation, aes(x=Date, y=Power))+geom_line(color="red")+labs(x="", y="", title = "Garland")

plot_ches<-ggplot(Chester_Generation, aes(x=Date, y=Power))+geom_line(color="red")+labs(x="", y="", title = "Chester")

plot_tri<-ggplot(Tri_County_Generation, aes(x=Date, y=Power))+geom_line(color="red")+labs(x="", y="", title = "Tri_County")

plot_glen<-ggplot(Glen_Canyon_Generation, aes(x=Date, y=Power))+geom_line(color="red")+labs(x="", y="", title = "Glen_Canyon")

plot_quail<-ggplot(Quail_Creek_Generation, aes(x=Date, y=Power))+geom_line(color="red")+labs(x="", y="", title = "Quail_Creek")

power_plot<-plot_grid(plot_hs, plot_school, plot_matson, plot_otis, plot_ws, plot_gar, plot_ches, plot_tri, plot_glen,plot_quail, ncol = 4, align="hv")
...
plot_grid(title_gg_2, power_plot, ncol = 1, rel_heights = c(0.08,1))
