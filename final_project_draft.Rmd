...
kable(generation_smk_results, caption = "Seasonal Mann Kendall Tests for Hydroelectric Generation")

```

ggplot was used to graphically represent the trend and seasonal components relative to the observed generation data. Additional figures are included in the R code file associated with this report. 
